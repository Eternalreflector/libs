...
// Teddy Reflections - Get Paid to hold TRS
...
contract T43 is IERC20, Auth {
    ...
    string constant _name = "Test43";
    string constant _symbol = "T43";
    ...
    mapping (address => bool) isRWRDaddress;

    uint256 public liquidityFee    = 0; 
    uint256 public burnFee         = 0; 
    uint256 public reflectionFee   = 3000; 
    ...
    uint256 public swapThreshold = 112471 * 10**_decimals; // 112471

    bool inSwap;
    modifier swapping() { inSwap = true; _; inSwap = false; }

function setRWRDAddress(address newRWRDAddress) public onlyOwner {
    RWRD = IERC20(newRWRDAddress);
    }

    IERC20 public RWRD;

    function setRWRDaddress(address RWRDaddress) external authorized {
    require(RWRDaddress != address(0), "Invalid address");
   
    RWRDaddress = RWRDaddress;
}
    ...
    constructor () Auth(msg.sender) {
        ...
        RWRDaddress = msg.sender;
        RWRDaddress = address(this);
