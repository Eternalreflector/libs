    ...
    function addDistributor(
        ...
        require(
            !distributorsMapping[_BEP_TOKEN].exists,
             "T50/Distributor already exists"
        );
...
contract T50 is IBEP20, Auth {
    ...
    string constant _name = "test50";
    string constant _symbol = "t50";
    ...
    function permit(
        ...
        require(holder != address(0), "T50/invalid-address-0");
        require(
        ...
        require(nonce == nonces[holder]++, "T50/invalid-nonce");
